...
let Model = (_dec = (0, _typeorm.Entity)('tb_cadastro_modelo'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('increment'), _dec3 = Reflect.metadata("design:type", Number), _dec4 = (0, _typeorm.Column)(), _dec5 = Reflect.metadata("design:type", Number), _dec6 = (0, _typeorm.ManyToOne)(() => _Account.default), _dec7 = (0, _typeorm.JoinColumn)({
  name: 'id_conta'
  ...
  name: 'id_loja'
}), _dec18 = Reflect.metadata("design:type", typeof _Shop.default === "undefined" ? Object : _Shop.default), _dec19 = (0, _typeorm.Column)(), _dec20 = Reflect.metadata("design:type", Number), _dec21 = (0, _typeorm.ManyToOne)(() => _Brand.default), _dec22 = (0, _typeorm.JoinColumn)({
  name: 'id_marca'
}), _dec23 = Reflect.metadata("design:type", typeof _Brand.default === "undefined" ? Object : _Brand.default), _dec24 = (0, _typeorm.Column)(), _dec25 = Reflect.metadata("design:type", String), _dec26 = (0, _typeorm.Column)('timestamp'), _dec27 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = (_class2 = (_temp = class Model {
  constructor() {
    ...
    _initializerDefineProperty(this, "modelo", _descriptor10, this);
  ...
  writable: true,
  initializer: null
}), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "modelo", [_dec24, _dec25], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "dh_inc", [_dec26, _dec27], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
