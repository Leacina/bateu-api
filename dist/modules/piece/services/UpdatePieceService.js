...
let UpdatePieceService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute(data) {
    ...
    if (piece) {
      ...
      piece.ds_imagem_dois = data.ds_imagem_dois === '' ? null : data.ds_imagem_dois;
      piece.ds_imagem_tres = data.ds_imagem_tres === '' ? null : data.ds_imagem_tres;
