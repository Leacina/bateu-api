...
let User = (_dec = (0, _typeorm.Entity)('tb_sistema_usuario_token'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('increment'), _dec3 = Reflect.metadata("design:type", String), _dec4 = (0, _typeorm.Column)(), _dec5 = (0, _typeorm.Generated)('uuid'), _dec6 = Reflect.metadata("design:type", String), _dec7 = (0, _typeorm.Column)(), _dec8 = Reflect.metadata("design:type", Number), _dec9 = (0, _typeorm.Column)('timestamp'), _dec10 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = (_class2 = (_temp = class User {
  constructor() {
    ...
    _initializerDefineProperty(this, "dh_inc", _descriptor4, this);
  }
  ...
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "dh_inc", [_dec9, _dec10], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
