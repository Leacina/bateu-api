...
}, _dec6 = Reflect.metadata("design:type", Function), _dec7 = Reflect.metadata("design:paramtypes", [typeof _IUserRepository.default === "undefined" ? Object : _IUserRepository.default, typeof _IShopsRepository.default === "undefined" ? Object : _IShopsRepository.default, typeof _IEstablishmentsRepository.default === "undefined" ? Object : _IEstablishmentsRepository.default, typeof _IAccountsRepository.default === "undefined" ? Object : _IAccountsRepository.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = _dec6(_class = _dec7(_class = class CreateUserService {
  /**
  ...
  async execute({
    ...
    if (tp_usuario) {
      if (tp_usuario !== 'F' && tp_usuario !== 'S' && tp_usuario !== 'O') {
        throw new _AppError.default('Tipo de usuário informado inválido');
      }
